...
//		assertTrue(UserNameErr.equals(userserr.getUsernameError()));
		assertEquals(UserNameErr, userserr.getUsernameError());
//		assertTrue(PwdErr.equals(userserr.getPasswordError()));
		assertEquals(PwdErr, userserr.getPasswordError());
		assertEquals(idErr, userserr.getUtaidError());
/*		assertTrue(idErr.equals(userserr.getUtaidError()));*/
